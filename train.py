...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", type=int, default=16, help="batch size of input")
    parser.add_argument("--epochs", type=int, default=200, help="total_epoch")
    ...
    jpg_path = '/media/mdisk/chenx2/stomach/malignant'
    seg_path = '/media/mdisk/chenx2/stomach/seg'
    ...
    datasets = Defect_Dataset(jpg_path, seg_path, seg_transforms(phase='train', resize=(opt.img_size, opt.img_size)))

    trainsize = int(len(datasets) * ratio_trainval)
    testsize = len(datasets) - trainsize
    train_set, val_set = torch.utils.data.random_split(datasets, [trainsize, testsize])
    ...
    # pth_dir = 'model/20200730_185945/model_lowest_loss.pth' #需要自己根据需求更改路径
